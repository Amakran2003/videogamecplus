...
void MainMenu::Init()
{
    ...
    m_gameTitle.setString("Pizza Snake Game");
    ...
    m_playButton.setPosition(m_context->m_window->getSize().x / 1.75f,
                             m_context->m_window->getSize().y / 2 - 25.f);
    m_playButton.setCharacterSize(20);

    // Exit Button
    m_exitButton.setFont(m_context->m_assets->GetFont(MAIN_FONT));
    m_exitButton.setString("Exit Game");
    m_exitButton.setOrigin(m_exitButton.getLocalBounds().width / 2,
                           m_exitButton.getLocalBounds().height / 2);
    m_exitButton.setPosition(m_context->m_window->getSize().x / 1.75f,
                             m_context->m_window->getSize().y / 2 + 25.f);
...
void MainMenu::Draw()
{
    m_context->m_window->clear(sf::Color(0, 153, 0));
